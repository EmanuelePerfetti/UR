function ddq = DynamicModelEquations(x, tau)
    %Model Parameters
    m1 = 1; m2 = 1/2; L1 = 1; d1 = 0.5; d2 = 0.5; I1zz = 1/12; I2zz = 0.5*12; g0 = 9.81;
    ...
    %Following equations are derivated from "Dynamic_model_derivation.m"
    ddq = zeros(2,1);
