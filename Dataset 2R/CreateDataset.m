...
experiment_duration = [15, 15]; %[for training, for validation]
number_of_experiments = [100, 15]; %[for training, for validation]
trainingRefPoints = generateRandomPoints(number_of_experiments(1));
validationRefPoints = generateRandomPoints(number_of_experiments(2));
